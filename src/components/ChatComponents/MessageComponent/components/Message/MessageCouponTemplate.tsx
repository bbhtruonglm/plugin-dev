...
const MessageCouponTemplate = ({ data }: { data: Data }) => {
  ...
  return (
    <div className="flex flex-col p-2 gap-y-1 ">
      <h4 className="text-sm font-medium text-center bg-gray-200 rounded-full py-2 px-4">
        {COUPON.coupon_pre_message}
      </h4>
      <div className="flex flex-col gap-y-2 bg-gray-200 rounded-lg">
        <img
        ...
        <div className="flex flex-col gap-y-2 p-2 bg-gray-200 rounded-lg">
          ...
          <button
            ...
            className="bg-white text-blue-600 font-semibold py-2 px-4 rounded-lg hover:bg-gray-100"
          >

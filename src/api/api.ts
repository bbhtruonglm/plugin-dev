...
import {
  ...
  DOMAIN_TRIGGER_BTN as DOMAIN_TRIGGER_BTN_DEVELOPMENT,
...
export const API_END_POINTS = {
  production: {
    ...
    DOMAIN_TRIGGER_BTN: DOMAIN_TRIGGER_BTN,
  },
  development: {
    ...
    DOMAIN_TRIGGER_BTN: DOMAIN_TRIGGER_BTN_DEVELOPMENT,
  },
  staging: {
    SOCKET_API: VITE_APP_SOCKET_HOST_DEVELOPMENT,
    READ_MESSAGE_API: `${VITE_APP_BE_HOST_DEVELOPMENT}/embed/message/read_message`,
